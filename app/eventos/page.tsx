  ...
  const featuredEvents = [
    {
      ...
      artists: ["ALEX RIVERA", "KEVIN BALBI", "BALTA"],
    ...
    },
    {
      ...
      artists: ["ALEX RIVERA", "KEVIN BALBI"],
    ...
    },
    {
      ...
      artists: ["KEVIN BALBI", "SPECIAL GUEST"],
  ...
  const upcomingEvents = [
    {
      ...
      artists: ["ALEX RIVERA", "BALTA", "KEVIN BALBI"],
    ...
    },
    {
      ...
      artists: ["KEVIN BALBI", "ALEX RIVERA"],
