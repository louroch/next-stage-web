...
export const YouTube = ({ className, size = 24, ...props }: { className?: string; size?: number; [key: string]: any }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const Spotify = ({ className, size = 24, ...props }: { className?: string; size?: number; [key: string]: any }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
